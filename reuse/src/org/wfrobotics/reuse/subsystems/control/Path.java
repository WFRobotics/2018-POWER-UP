 ...
 *
 * <p>Class representing the robot's autonomous path.
 *
 * <p>Field Coordinate System: Uses a right hand coordinate system. Positive x is right, positive y is up, and the origin
...
public class Path {
    ...
    private static final double kSegmentCompletionTolerance = 0.1;  // Inches
    ...
    public void verifySpeeds() {
        ...
        for (int i = segments.size() - 1; i >= 0; i--) {
            ...
            maxStartSpeed += Math
                                            .sqrt(maxStartSpeed * maxStartSpeed + 2 * kPathFollowingMaxAccel * segment.getLength());
