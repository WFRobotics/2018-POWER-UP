 ...
 *
 * <p>A PathFollower follows a predefined path using a combination of feedforward and feedback control. It uses an
...
public class PathFollower {
    ...
    public synchronized Twist2d update(double t, Pose2d pose, double displacement, double velocity) {
        if (!mSteeringController.isFinished()) {
            final PurePursuitController.PursuitCommand steering_command = mSteeringController.update(pose);
