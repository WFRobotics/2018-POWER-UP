...
public abstract class TalonConfig
{
    ...
    public static class Gains
    {
        ...
        public Optional<Integer> kCruiseVelocity;
        public Optional<Integer> kAcceleration;
        ...
        public Gains(String name, int slot, double kP, double kI, double kD, double kF, int iZone)
        {
            ...
            this.kF = kF;
            kIZone = iZone;
            kCruiseVelocity = Optional.empty();
            kAcceleration = Optional.empty();
        }

        public Gains(String name, int slot, double kP, double kI, double kD, double kF, int iZone, int cruiseVelocity, int acceleration)
        {
            this(name, slot, kP, kI, kD, kF, iZone);
            kCruiseVelocity = Optional.of(cruiseVelocity);
            kAcceleration = Optional.of(acceleration);
        }
        ...
        public String toString()
        {
            ...
            if (kCruiseVelocity.isPresent() && kAcceleration.isPresent())
            {
